...
import com.wy.service.TransactionalMessageService;
import com.wy.support.binding.DefaultDestination;
import com.wy.support.binding.ExchangeType;
import com.wy.support.messeage.DefaultTxMessage;
...
public class MockBusinessService {
    ...
    public void saveOrder() throws Exception {
        ...
        //jdbcTemplate.update("INSERT INTO t_order(order_id,amount) VALUES ('"+orderId+"',"+amount+")");
